...
public static class SitemapExtension
{
    ...
    public static async Task<bool> SaveAsync(this ISitemap sitemap, string path, IFileSystemWrapper fileSystemWrapper)
    {
        try
        {
            var serializer = new SitemapSerializer();
    ...
    public static bool Save(this ISitemap sitemap, string path, IFileSystemWrapper fileSystemWrapper)
    {
        try
        {
            var serializer = new SitemapSerializer();
